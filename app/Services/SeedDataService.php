...
final class SeedDataService
{
    ...
    {
        return [
            ['id' => 'tx-1', 'inventory_item_id' => 'inv-1', 'inventory_item_name' => 'Caputo 00 Pizza Flour', 'quantity' => 50, 'type' => 'restock', 'reference' => 'Opening Stock Inflow', 'created_at' => '2026-08-15 08:00:00', 'notes' => 'Initial batch delivery'],
            ['id' => 'tx-2', 'inventory_item_id' => 'inv-2', 'inventory_item_name' => 'Fior di Latte Mozzarella', 'quantity' => 24, 'type' => 'restock', 'reference' => 'Dairy Wholesaler Delivery', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-3', 'inventory_item_id' => 'inv-3', 'inventory_item_name' => 'San Marzano D.O.P. Tomatoes', 'quantity' => 60, 'type' => 'restock', 'reference' => 'Italian Import Order #881', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-4', 'inventory_item_id' => 'inv-4', 'inventory_item_name' => 'Fresh Genovese Basil', 'quantity' => 18, 'type' => 'restock', 'reference' => 'Local Organic Farm Delivery', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-5', 'inventory_item_id' => 'inv-5', 'inventory_item_name' => 'Prosciutto di Parma 24-Mo', 'quantity' => 12, 'type' => 'restock', 'reference' => 'Salumeria Import', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-6', 'inventory_item_id' => 'inv-6', 'inventory_item_name' => 'Parmigiano Reggiano D.O.P.', 'quantity' => 15, 'type' => 'restock', 'reference' => 'Cheese Wheel Delivery', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-7', 'inventory_item_id' => 'inv-7', 'inventory_item_name' => 'Black Truffle Sauce', 'quantity' => 10, 'type' => 'restock', 'reference' => 'Umbria Specialty Co', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-8', 'inventory_item_id' => 'inv-8', 'inventory_item_name' => 'Savoiardi Ladyfingers', 'quantity' => 30, 'type' => 'restock', 'reference' => 'Pastry Supply Warehouse', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-9', 'inventory_item_id' => 'inv-9', 'inventory_item_name' => 'Mascarpone Cheese', 'quantity' => 14, 'type' => 'restock', 'reference' => 'Dairy Wholesaler Delivery', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-10', 'inventory_item_id' => 'inv-10', 'inventory_item_name' => 'Italian Espresso Roast', 'quantity' => 10, 'type' => 'restock', 'reference' => 'Roastery Delivery', 'created_at' => '2026-08-15 08:00:00'],
            ['id' => 'tx-11', 'inventory_item_id' => 'inv-1', 'inventory_item_name' => 'Caputo 00 Pizza Flour', 'quantity' => -3.5, 'type' => 'prep_deduction', 'reference' => 'Order #AB-1001 & AB-1004', 'created_at' => '2026-08-19 14:30:00'],
            ['id' => 'tx-12', 'inventory_item_id' => 'inv-2', 'inventory_item_name' => 'Fior di Latte Mozzarella', 'quantity' => -2.8, 'type' => 'prep_deduction', 'reference' => 'Order #AB-1001 & AB-1004', 'created_at' => '2026-08-19 14:30:00'],
            ['id' => 'tx-13', 'inventory_item_id' => 'inv-3', 'inventory_item_name' => 'San Marzano D.O.P. Tomatoes', 'quantity' => -4.0, 'type' => 'prep_deduction', 'reference' => 'Order #AB-1001 & AB-1004', 'created_at' => '2026-08-19 14:30:00'],
        ];
    }
            ...
            [
                ...
                'payments' => [
                    [
                        ...
                        'created_at' => '2026-08-19 18:45:00',
                        'notes' => 'Paid $50 cash at counter. $5.36 change returned.',
                    ],
                ],
                'created_at' => '2026-08-19 18:42:10',
                'updated_at' => '2026-08-19 18:45:00',
            ],
            [
                'id' => 'ord-102',
                ...
                'total' => 37.56,
                'payments' => [],
                'created_at' => '2026-08-19 19:05:22',
                'updated_at' => '2026-08-19 19:05:22',
            ],
            [
                'id' => 'ord-103',
                ...
                'payments' => [
                    [
                        ...
                        'cashier_id' => 'usr-2',
                        'cashier_name' => 'Sophia Rossi',
                        'created_at' => '2026-08-19 18:20:00',
                        'notes' => 'Deposit paid $30. Uncollected balance: $23.35',
                    ],
                ],
                'created_at' => '2026-08-19 18:15:00',
                'updated_at' => '2026-08-19 18:35:00',
            ],
            [
                'id' => 'ord-104',
                ...
                'payments' => [
                    [
                        ...
                        'cashier_id' => 'usr-2',
                        'cashier_name' => 'Sophia Rossi',
                        'created_at' => '2026-08-19 17:50:00',
                        'notes' => 'Exact cash tendered. Change: $2.78',
                    ],
                ],
                'created_at' => '2026-08-19 17:30:00',
                'updated_at' => '2026-08-19 18:00:00',
            ],
        ];
    }
